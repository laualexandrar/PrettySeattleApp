...
import com.lroap.prettyseattle.model.Ubication
...
class UbicationFragment : Fragment(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        markerOptions.title("PrettySeattle Hi")

        val bitmapDraw = context?.applicationContext?.let { ContextCompat.getDrawable(it, R.drawable.pin_pin) } as BitmapDrawable
